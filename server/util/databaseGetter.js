...
const DiMS48Database = mongoose.createConnection(DiMS48ConnectionString, {useNewUrlParser: true});
const TestDatabase = mongoose.createConnection(testConnectionString, {useNewUrlParser: true});
